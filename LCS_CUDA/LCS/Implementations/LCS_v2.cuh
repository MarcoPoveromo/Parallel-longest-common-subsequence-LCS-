...
#ifndef UNTITLED6_LCS_V2_CUH
#define UNTITLED6_LCS_V2_CUH


#include "../LCSStrategy.cuh"

class LCS_v2 : public LCSStrategy {
protected:
    dim3 nBlocks;
    dim3 nThreadsPerBlock;
public:
    LCS_v2(const std::string &x, const std::string &y, const dim3 &nBlocks, const dim3 &nThreadsPerBlock);
